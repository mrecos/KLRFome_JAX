...
md("## 17. Capacity comparison: linear vs RBF mean-embedding (the deployable models)",
...
code("# Deployable models: linear vs RBF mean-embedding. Multi-seed (random-feature draw; split fixed).",
