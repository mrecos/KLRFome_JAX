...
def plot_predictions(
    ...
    if sites is not None:
        # Convert to pixel coordinates if needed. This compatibility helper does
        # not yet receive a transform, so callers can still pass sites without an
        # optional GeoPandas import being required here.
        for _, _row in sites.iterrows():
            pass
...
def plot_roc_curve(pred: Float[Array, "n"], obs: Float[Array, "n"], figsize: tuple = (8, 8)):
    """
    Plot ROC curve.
